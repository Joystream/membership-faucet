...
export const GLOBAL_API_LIMIT_INTERVAL_HOURS = readEnvInt('GLOBAL_API_LIMIT_INTERVAL_HOURS', 1)
export const GLOBAL_API_LIMIT_MAX_IN_INTERVAL = readEnvInt('GLOBAL_API_LIMIT_MAX_IN_INTERVAL', 10)
export const PER_IP_API_LIMIT_INTERVAL_HOURS = readEnvInt('PER_IP_API_LIMIT_INTERVAL_HOURS', 48)
export const PER_IP_API_LIMIT_MAX_IN_INTERVAL = readEnvInt('PER_IP_API_LIMIT_MAX_IN_INTERVAL', 1)

export const ENABLE_API_THROTTLING = (() => {
    const enable = process.env.ENABLE_API_THROTTLING
    return enable && ['true', 'yes', 'y', '1', 'on'].includes(enable.toLowerCase())
})()

export const MIN_HANDLE_LENGTH = 1;
export const MAX_HANDLE_LENGTH = 100;

export const EMAIL_ALERTS_LIMIT_INTERVAL_HOURS = readEnvInt('EMAIL_ALERTS_LIMIT_INTERVAL_HOURS', 1)
export const EMAIL_ALERTS_LIMIT_MAX_IN_INTERVAL = readEnvInt('EMAIL_ALERTS_LIMIT_MAX_IN_INTERVAL', 5)
